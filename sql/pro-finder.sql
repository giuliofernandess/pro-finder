...
--
-- Host: 127.0.0.1:3316
-- Tempo de geração: 25/06/2025 às 00:08
...
ALTER TABLE `city`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Cidade_estado` (`state`);
...
--
ALTER TABLE `professional`
  MODIFY `id_professional` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `accounts`
  ADD CONSTRAINT `accounts_ibfk_1` FOREIGN KEY (`state`) REFERENCES `state` (`id`),
  ADD CONSTRAINT `accounts_ibfk_2` FOREIGN KEY (`city`) REFERENCES `city` (`id`);
COMMIT;
